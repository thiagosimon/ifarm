...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    // Simulate API call — wire to backend /retailers endpoint when available
          ...
          {done ? (
            ...
            <>
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                {/* Step 3: Access credentials + LGPD */}
                {step === 3 && (
                  <>
                    <div>
                      <label className="block text-xs font-bold uppercase tracking-widest text-on-surface-variant mb-2 ml-1">
                    ...
                    <div className="space-y-3 pt-2">
                      <label className="flex items-start gap-3 cursor-pointer group">
                        <input
                          className="mt-0.5 h-4 w-4 rounded border-outline-variant bg-surface-container text-primary focus:ring-primary"
                          required
                          type="checkbox"
